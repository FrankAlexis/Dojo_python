...
text_input = StringVar() #Escuchador
operador = ""
...
Addiction = Button(frame, font = ("SHOWCRAD GOTHIC", 50, 'bold'),command = lambda:btnClick("+")).grid(row=2, column=2)

Equals = Button(frame, font = ("SHOWCRAD GOTHIC", 50, 'bold'),command = btnEval).grid(row=2, column=3)
